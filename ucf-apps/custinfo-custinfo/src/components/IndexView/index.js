...
class IndexView extends Component {
    ...
    onRefreshList = () => {
        actions.popupEditcustinfo.loadList(this.props.queryParam);
    }
    ...
    confirmGoBack(type) {
        ...
        if (type === 1) { // 确定
            ...
            actions.popupEditcustinfo.removeList(record);
        }
    }
...
afterRowFilter = (status) => {
    if (!status) { 
        ...
        actions.popupEditcustinfo.updateState({queryParam}); //缓存查询条件
        actions.popupEditcustinfo.loadList(queryParam);
    }
        ...
        },
        {
            ...
            sorter: true,
                ...
                render(text,record,index){
                    return record['cust_sexEnumValue'];
                }
        },
        {
            title: "客户编码",
        ...
        return (
            <div className='single-table-popup'>
                ...
                <div className='table-header'>
                                    <ButtonRoleGroup funcCode="custinfo">
                        <Button
                            role="add"
                            colors="primary"
                            className="ml8"
